...
let favoriteDeserts:[String] = ["Banana Pudding", "Chocolate Lava Cake", "Homemade 7-up Cake"]
print(favoriteDeserts)
 ...
 */
var students:[String] = ["Joseph", "Tom", "Vonda", "Alexis", "Edward", "Andrew", "Christian", "Eduardo", "Justin"]
